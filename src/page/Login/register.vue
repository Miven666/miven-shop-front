        ...
        <div class="registered">
          ...
          <div class="content" style="margin-top: 20px;">
            ...
            <div style="margin-bottom: 30px;">
              <y-button
                :classStyle="registered.userPwd&&registered.userPwd2&&registered.userName&&registryTxt==='注册'?'main-btn':'disabled-btn'"
                :text="registryTxt"
            ...
            <ul class="common-form pr">
              ...
              <li style="text-align: center;line-height: 48px;margin-bottom: 0;font-size: 12px;color: #999;">
                <span>如果您已拥有 miven-shop 账号，则可在此</span>
                <a href="javascript:"
                   style="margin: 0 5px"
                   @click="toLogin">登陆</a>
              </li>
